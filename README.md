...
[![ci](https://github.com/liquidaty/json2toon/actions/workflows/ci.yml/badge.svg)](https://github.com/liquidaty/json2toon/actions/workflows/ci.yml)
...
application, processes input incrementally, and runs in bounded memory regardless
of how large the input or output is.
